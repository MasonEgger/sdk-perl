#!/usr/bin/perl
# ABOUTME: Test 1b - same as test1 but with Attribute::Handlers in same package as class
use v5.38;
use feature 'class';
no warnings 'experimental::class';

# Try: define handler in a package, then use inheritance via MODIFY_CODE_ATTRIBUTES
package Temporalio::Workflow::Definition {

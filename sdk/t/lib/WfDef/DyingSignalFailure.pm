...
# ABOUTME: Temporalio::Exception::Application — drives the FailWorkflowExecution
...
# failure-type exception (Application), which — MUST-match sdk-python
# (worker/_workflow_instance.py:2560-2562 _run_top_level_workflow_function:
# workflow_is_failure_exception -> _set_workflow_failure) — fails the workflow
# EXECUTION (FailWorkflowExecution), not the workflow task, unlike
# WfDef::DyingSignal's plain die.
